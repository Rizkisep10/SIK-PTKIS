...
--
-- Host: 127.0.0.1
-- Generation Time: 13 Mar 2018 pada 02.28
...
--
-- Struktur dari tabel `data_berita_faks`
--
...
--
-- Dumping data untuk tabel `data_berita_faks`
--
...
--
-- Struktur dari tabel `data_berita_jurs`
--
...
--
-- Dumping data untuk tabel `data_berita_jurs`
--
...
--
-- Struktur dari tabel `data_berita_univs`
--
...
--
-- Dumping data untuk tabel `data_berita_univs`
--
...
--
-- Ketidakleluasaan untuk tabel `data_berita_faks`
--
ALTER TABLE `data_berita_faks`
...
--
-- Ketidakleluasaan untuk tabel `data_berita_jurs`
--
ALTER TABLE `data_berita_jurs`
...
--
-- Ketidakleluasaan untuk tabel `data_berita_univs`
--
ALTER TABLE `data_berita_univs`
